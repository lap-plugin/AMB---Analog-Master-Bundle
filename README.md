# 🎛️ ApEQ Series — Parametric EQ for Linux Audio
...
> **LAP** = Linux Audio Plugin · CLAP / VST3 · cross-platform (Linux)
...
> **Tip:** some DAWs cache old versions. If you rebuild, fully remove and
> re-add the plugin rather than just rescanning.
...
- **[docs/MANUAL_ApEQ_SERIES.md](./docs/MANUAL_ApEQ_SERIES.md)** — user manual (all parameters)
- **[docs/INSTALLATION.md](./docs/INSTALLATION.md)** — step-by-step installation
- **[docs/DEVELOPMENT.md](./docs/DEVELOPMENT.md)** — developer guide

---

**Version:** 1.0.0-beta · **License:** MIT · **Vendor:** LAP (Linux Audio Plugin)

🎵 *Enjoy professional audio processing!*
